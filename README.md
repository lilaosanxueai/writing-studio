...
| ✍️ 文案 | **顶尖文案工艺**：通用文笔铁律 + 8 种文体手法手册 + 风格库（咪蒙式/九边式/罗翔式/罗振宇式/自定义，分组下拉）；**⚡ 三稿竞标**（叙事切入/观点直给/反常识破题三角度并行出稿，择优一键删余稿）；**🩺 成稿体检**（人味/具体度/节奏/金句密度四维严苛评分 + 问题定位 + 按建议打磨）；两段式 💎 打磨管道；8 格式 × 5 语气 × 3 长度；素材精选；流式生成、指令改写、手工编辑、复制/下载/存飞书 |
| 🌅 日签与引领 | 空状态页每日写作提示（基于画像+灵感库生成开场/切入/小挑战，一键开聊）；搭档在岔路口主动给出 ▶ 可点方向选项 |
| 📤 导出 | 整个话题一键导出 Markdown（分析+灵感+讨论+小结+文案）；灵感库增量同步飞书独立文档 |
