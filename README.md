...
| 🏷 话题分析 | 首轮聊完自动分析：分类（观点评论/个人故事/产品点子/知识科普/创意脑洞/情绪随笔/方法工具）+ 关键词 + 一句话定位，每 8 轮自动刷新，可手动重跑；顶栏按分类筛选话题 |
| 💡 灵感 | 💡 行一键收下、消息 ⭐ 收藏、手动速记；可编辑备注；自动写进飞书 |
| 📌 小结 | 一键生成讨论主线 / 已成形观点 / 金句 / 待深挖 |
| ✍️ 文案 | 8 种格式（公众号/小红书/朋友圈/口播稿/金句合集/演讲提纲/深度长文/自定义）× 5 种语气 × 3 档长度；话题分析会推荐适合的格式，一键套用；流式生成、指令改写、手工编辑、复制/下载/存飞书 |
